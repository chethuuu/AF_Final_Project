...
const {upload, uploadImage, deleteAllDoc, deleteDoc, getAllDocuments, getDocument, updateDocument} = require('../controller/fileUploadController')
...
router.put('/updateDoc/:id', updateDocument);
