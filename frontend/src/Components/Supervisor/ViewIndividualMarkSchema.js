...
export default function ViewIndividualMarkSchema() {
    ...
    useEffect(() => {
        const getEvaluationMarks = async () => {
            try {
                const res = await axios.get(`http://localhost:5000/doc/getone/${id}`)
        ...
        <div>
            ...
            <div class="container shadow my-5 col-md-9 p-6 align-items-center">
                <div className="d-flex flex-column text-dark justify-content-center" > <br />
                    <h3 className=" fw-bolder mb-4"><center>Documentation {Evaludetails.group_id} Evaluation Details</center></h3>  <br />
                    <form>
