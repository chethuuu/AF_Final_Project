    ...
    useEffect(() =>{
        const getGroupData = async() =>{
            try{
                ...
                if(groupDetails.pannel_status == 'Assigned'){
                    //const res = await axios.get(`http://localhost:5000/group/getone/${id}`)
    ...
    return(
        <div>
            <div class="card">
                ...
                <div class="card-body">  
                    <h6 class="card-title"><u>Pannel Member1</u></h6>
                    <label><b>ID: </b>{panelDetails.pannel.panel1.ID}</label><br/>
                    <label><b>Name : </b>{panelDetails.pannel.panel1.name}</label> <br/>
                    <label><b>Email: </b>{panelDetails.pannel.panel1.email}</label>

                    <h6 class="card-title"><u>Pannel Member2</u></h6>
                    <label><b>ID: </b>{panelDetails.pannel.panel2.ID}</label><br/>
                    <label><b>Name : </b>{panelDetails.pannel.panel2.name}</label> <br/>
                    <label><b>Email: </b>{panelDetails.pannel.panel2.email}</label>
                </div>
