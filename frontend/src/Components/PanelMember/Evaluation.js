...
export default function Evaluation() {
    ...
    //const [Schemedetails, setSchemedetails] = useState({subject:"", assignment:"", date:""});

    const [group_id, setgroup_id] = useState("");
    const [details, setdetails] = useState({subject:"", assignment:"", date:"", 
    ...
    const resetForm = () => {
        ...
        setdetails({subject:"", assignment:"", date:"", 
                    point:"", point1:"", point2:"", point3:"",
                    marks:"", marks1:"", marks2:"", marks3:""});
        setamount({ amount: ""});
        setamount1({ amount1: ""});
                ...
                <div className="d-flex flex-column text-dark justify-content-center" >   
                    <div class="card-header">
                        ...
                        <form onSubmit={sendData} >
                            ...
                            <center>
                                <button type="submit" class="btn btn-primary col-md-8">Save</button>
                            </center>
