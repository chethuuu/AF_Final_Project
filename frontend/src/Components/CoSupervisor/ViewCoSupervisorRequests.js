          ...
          <tbody class="table-group-divider">
            {
              listTopic.map((topic, id) => (
                <tr>
                  ...
                  <td><button className='btn btn-warning'>{topic.status_co}</button></td>
                  <td><Link to={`/cosupreq/${topic._id}`}><Button className='btn btn-danger'>Accept / Reject</Button></Link> </td>
